    ...
    <div className="max-w-screen-lg m-auto pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-10">
        <div className="col-span-1 pl-4">
          <div className="rounded-2xl bg-white px-6 md:px-10 py-6 mb-6 md:mb-10 ">
            <div className="flex flex-col justify-center items-center">
              ...
              ></div>
              <h3 className="text-3xl font-bold py-4 capitalize">{hospitalData?.fullName}</h3>
            </div>
            <div className="flex flex-col gap-3 mt-2">
              ...
              <div className={cx('flex items-center gap-2')}>
                <IoMdTime />
                <span className="text-xl">Thứ 2 - thứ 6</span>
              </div>
              <div className={cx('flex items-center gap-2')}>
                <MdOutlinePhoneInTalk />
                <span className="text-xl">Hổ trợ đặt khám: 1900 1514 </span>
              </div>
            </div>
          </div>
        ...
        <div className="col-span-2 px-4">
          ...
          <div className=" rounded-2xl p-6 md:hidden mb-8">
            <img alt="Gói khám" src={require('~/assets/images/errImg.png')} />
            <div className="col-span-1 bg-white rounded-2xl p-12 mt-10">
              <h2 className="font-bold text-3xl">Mô tả</h2>
              <span className="text-xl">{hospitalData?.description}</span>
          ...
          <div className="rounded-2xl bg-red-50 p-6">
            ...
            <ul className="mb-6 list-disc pl-6">
              ...
              <li>
                Trải qua hơn 100 năm hình thành và phát triển, bệnh viện đã đạt được nhiều thành tích cao quý như đạt
                xếp loại bệnh viện hạng II (1994) và hạng I (2010), lần lượt đạt tiêu chuẩn vàng và tiêu chuẩn bạch kim
                của Hội đột quỵ thế giới, nhiều năm liền là bệnh viện xuất sắc toàn diện do Bộ Y tế quyết định khen
                thưởng, đạt danh hiệu huân chương lao động hạng 3 do Chủ tịch nước trao tặng ngày 30/09/2011 và còn rất
                nhiều thành tích do Bộ Y tế, Ủy ban nhân dân tỉnh Đồng Nai trao tặng…
              </li>
            </ul>
            ...
            <ul className="mb-6 list-disc pl-6">
              <li>
                Bệnh viện có quy mô 1100 giường nội trú và tiếp nhận khoảng 3000 lượt khám bệnh ngoại trú mỗi ngày.
              </li>
              <li>
                Bệnh viện có trang thiết bị y tế hiện đại như máy CT 256 lát cắt 2 cấp năng lượng, máy MRI 3 Tesla, Máy
                DSA can thiệp mạch máu, 3 hệ thống xét nghiệm tự đồng hiện đại, máy siêu âm màu 3D, 4D, máy X-quang kỹ
                thuật số…
              </li>
            </ul>
            ...
            <p className="mb-4">
              Trong tương lai, Bệnh viện Đa khoa Đồng Nai hướng tới trở thành một bệnh viện đa khoa, toàn diện, chuyên
              sâu và chất lượng cao hàng đầu khu vực phía nam, từng bước xây dựng bệnh viện đủ tiêu chuẩn xếp hạng bệnh
              viện đặc biệt.
            </p>
          </div>
        </div>
